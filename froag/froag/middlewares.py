...
import random, base64, os, logging
...
from froag import fetch_free_proxyes

class FroagSpiderMiddleware(object):
...
class HttpProxyMiddleware(object):
    ...
    def inc_proxy_index(self):
        """将代理列表的索引移到下一个有效代理的位置如果发现代理列表只有fixed_proxy项有效, 重置代理列表如果还发现已经距离上次抓代理过了指定时间, 则抓取新的代理
        """
    ...
    def invalid_proxy(self, index):
        """将index指向的proxy设置为invalid, 并调整当前proxy_index到下一个有效代理的位置"""
...
#         '36.97.171.201:8998',
#         '211.65.64.19:80',
#         '121.204.165.142:8118',
#         '61.191.173.31:808',
#         '221.216.94.77:808',
#         '124.88.67.19:80',
#         '124.88.67.13:80',
#         '223.240.147.76:13564',
#         '117.35.20.67:8118',
#         '61.186.164.98:8080',
#         '1.190.134.93:8118',
#         '112.86.84.173:59226',
